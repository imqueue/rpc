 ...
 * A copy of the same harness in `@imqueue/core`. It is duplicated rather than
 * shared because a package's `test/` directory is not published, so there is
 * nothing to import; keep the two in step when either changes.
 *
